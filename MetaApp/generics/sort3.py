...
filelist = ["04161921gray","05140921gray2","05140921gray"]
...
print(resultlist[2])
print(sum(resultlist[2]))

x = [i for i in range(1,28)]
plt.figure(figsize=(30,10))

plt.bar([i-0.33 for i in range(1,28)],[i for i in resultlist[0]],width=0.33,label="old")
plt.bar([i for i in range(1,28)],[i for i in resultlist[1]],width=0.33,label="new_1")
plt.bar([i+0.33 for i in range(1,28)],[i for i in resultlist[2]],width=0.33,label="new_2")
